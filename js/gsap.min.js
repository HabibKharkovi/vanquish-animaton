...
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports):"function"==typeof define&&define.amd?define(["exports"],t):t((e=e||self).window=e.window||{})}(this,function(e){"use strict";function t(e){return g.getComputedStyle(e)}function i(e,t){var i;return C(e)?e:"string"==(i=typeof e)&&!t&&e?S.call(u.querySelectorAll(e),0):e&&"object"==i&&"length"in e?S.call(e,0):e?[e]:[]}function n(e){return"absolute"===e.position||!0===e.absolute}function s(e,t){for(var i,n=t.length;-1<--n;)if(i=t[n],e.substr(0,i.length)===i)return i.length}function r(e,t){void 0===e&&(e="");var i=~e.indexOf("++"),n=1;return i&&(e=e.split("++").join("")),function(){return"<"+t+" style='position:relative;display:inline-block;'"+(e?" class='"+e+(i?n++:"")+"'>":">")}}function l(e,t,i){var n=e.nodeType;if(1===n||9===n||11===n)for(e=e.firstChild;e;e=e.nextSibling)l(e,t,i);else 3!==n&&4!==n||(e.nodeValue=e.nodeValue.split(t).join(i))}function o(e,t){for(var i=t.length;-1<--i;)e.push(t[i])}function d(e,t,i){for(var n;e&&e!==t;){if(n=e._next||e.nextSibling)return n.textContent.charAt(0)===i;e=e.parentNode||e._parent}}function a(e){var t,n,s=i(e.childNodes),r=s.length;for(t=0;t<r;t++)(n=s[t])._isSplit?a(n):(t&&3===n.previousSibling.nodeType?n.previousSibling.nodeValue+=3===n.nodeType?n.nodeValue:n.firstChild.nodeValue:3!==n.nodeType&&e.insertBefore(n.firstChild,n),e.removeChild(n))}function p(e,t){return parseFloat(t[e])||0}function h(e,i,s,r,h,f,c){var g,x,y,v,b,_,C,S,w,N,m,T,L=t(e),A=p("paddingLeft",L),B=-999,W=p("borderBottomWidth",L)+p("borderTopWidth",L),H=p("borderLeftWidth",L)+p("borderRightWidth",L),O=p("paddingTop",L)+p("paddingBottom",L),V=p("paddingLeft",L)+p("paddingRight",L),j=.2*p("fontSize",L),E=L.textAlign,M=[],R=[],k=[],F=i.wordDelimiter||" ",D=i.tag?i.tag:i.span?"span":"div",P=i.type||i.split||"chars,words,lines",q=h&&~P.indexOf("lines")?[]:null,z=~P.indexOf("words"),G=~P.indexOf("chars"),I=n(i),J=i.linesClass,K=~(J||"").indexOf("++"),Q=[];for(K&&(J=J.split("++").join("")),y=(x=e.getElementsByTagName("*")).length,b=[],g=0;g<y;g++)b[g]=x[g];if(q||I)for(g=0;g<y;g++)((_=(v=b[g]).parentNode===e)||I||G&&!z)&&(T=v.offsetTop,q&&_&&Math.abs(T-B)>j&&("BR"!==v.nodeName||0===g)&&(C=[],q.push(C),B=T),I&&(v._x=v.offsetLeft,v._y=T,v._w=v.offsetWidth,v._h=v.offsetHeight),q&&((v._isSplit&&_||!G&&_||z&&_||!z&&v.parentNode.parentNode===e&&!v.parentNode._isSplit)&&(C.push(v),v._x-=A,d(v,e,F)&&(v._wordEnd=!0)),"BR"===v.nodeName&&(v.nextSibling&&"BR"===v.nextSibling.nodeName||0===g)&&q.push([])));for(g=0;g<y;g++)_=(v=b[g]).parentNode===e,"BR"!==v.nodeName?(I&&(w=v.style,z||_||(v._x+=v.parentNode._x,v._y+=v.parentNode._y),w.left=v._x+"px",w.top=v._y+"px",w.position="absolute",w.display="block",w.width=v._w+1+"px",w.height=v._h+"px"),!z&&G?v._isSplit?(v._next=v.nextSibling,v.parentNode.appendChild(v)):v.parentNode._isSplit?(v._parent=v.parentNode,!v.previousSibling&&v.firstChild&&(v.firstChild._isFirst=!0),v.nextSibling&&" "===v.nextSibling.textContent&&!v.nextSibling.nextSibling&&Q.push(v.nextSibling),v._next=v.nextSibling&&v.nextSibling._isFirst?null:v.nextSibling,v.parentNode.removeChild(v),b.splice(g--,1),y--):_||(T=!v.nextSibling&&d(v.parentNode,e,F),v.parentNode._parent&&v.parentNode._parent.appendChild(v),T&&v.parentNode.appendChild(u.createTextNode(" ")),"span"===D&&(v.style.display="inline"),M.push(v)):v.parentNode._isSplit&&!v._isSplit&&""!==v.innerHTML?R.push(v):G&&!v._isSplit&&("span"===D&&(v.style.display="inline"),M.push(v))):q||I?(v.parentNode&&v.parentNode.removeChild(v),b.splice(g--,1),y--):z||e.appendChild(v);for(g=Q.length;-1<--g;)Q[g].parentNode.removeChild(Q[g]);if(q){for(I&&(N=u.createElement(D),e.appendChild(N),m=N.offsetWidth+"px",T=N.offsetParent===e?0:e.offsetLeft,e.removeChild(N)),w=e.style.cssText,e.style.cssText="display:none;";e.firstChild;)e.removeChild(e.firstChild);for(S=" "===F&&(!I||!z&&!G),g=0;g<q.length;g++){for(C=q[g],(N=u.createElement(D)).style.cssText="display:block;text-align:"+E+";position:"+(I?"absolute;":"relative;"),J&&(N.className=J+(K?g+1:"")),k.push(N),y=C.length,x=0;x<y;x++)"BR"!==C[x].nodeName&&(v=C[x],N.appendChild(v),S&&v._wordEnd&&N.appendChild(u.createTextNode(" ")),I&&(0===x&&(N.style.top=v._y+"px",N.style.left=A+T+"px"),v.style.top="0px",T&&(v.style.left=v._x-T+"px")));0===y?N.innerHTML="&nbsp;":z||G||(a(N),l(N,String.fromCharCode(160)," ")),I&&(N.style.width=m,N.style.height=v._h+"px"),e.appendChild(N)}e.style.cssText=w}I&&(c>e.clientHeight&&(e.style.height=c-O+"px",e.clientHeight<c&&(e.style.height=c+W+"px")),f>e.clientWidth&&(e.style.width=f-V+"px",e.clientWidth<f&&(e.style.width=f+H+"px"))),o(s,M),z&&o(r,R),o(h,k)}function f(e,t,i,r){var o,d,a,p,h,f,c,g,x=t.tag?t.tag:t.span?"span":"div",y=~(t.type||t.split||"chars,words,lines").indexOf("chars"),C=n(t),S=t.wordDelimiter||" ",w=" "!==S?"":C?"&#173; ":" ",N="</"+x+">",m=1,T=t.specialChars?"function"==typeof t.specialChars?t.specialChars:s:null,L=u.createElement("div"),A=e.parentNode;for(A.insertBefore(L,e),L.textContent=e.nodeValue,A.removeChild(e),c=-1!==(o=function e(t){var i=t.nodeType,n="";if(1===i||9===i||11===i){if("string"==typeof t.textContent)return t.textContent;for(t=t.firstChild;t;t=t.nextSibling)n+=e(t)}else if(3===i||4===i)return t.nodeValue;return n}(e=L)).indexOf("<"),!1!==t.reduceWhiteSpace&&(o=o.replace(_," ").replace(b,"")),c&&(o=o.split("<").join("{{LT}}")),h=o.length,d=(" "===o.charAt(0)?w:"")+i(),a=0;a<h;a++)if(f=o.charAt(a),T&&(g=T(o.substr(a),t.specialChars)))f=o.substr(a,g||1),d+=y&&" "!==f?r()+f+"</"+x+">":f,a+=g-1;else if(f===S&&o.charAt(a-1)!==S&&a){for(d+=m?N:"",m=0;o.charAt(a+1)===S;)d+=w,a++;a===h-1?d+=w:")"!==o.charAt(a+1)&&(d+=w+i(),m=1)}else"{"===f&&"{{LT}}"===o.substr(a,6)?(d+=y?r()+"{{LT}}</"+x+">":"{{LT}}",a+=5):55296<=f.charCodeAt(0)&&f.charCodeAt(0)<=56319||65024<=o.charCodeAt(a+1)&&o.charCodeAt(a+1)<=65039?(p=((o.substr(a,12).split(v)||[])[1]||"").length||2,d+=y&&" "!==f?r()+o.substr(a,p)+"</"+x+">":o.substr(a,p),a+=p-1):d+=y&&" "!==f?r()+f+"</"+x+">":f;e.outerHTML=d+(m?N:""),c&&l(A,"{{LT}}","<")}function c(e,s,r,l){var o,d,a=i(e.childNodes),p=a.length,h=n(s);if(3!==e.nodeType||1<p){for(s.absolute=!1,o=0;o<p;o++)3===(d=a[o]).nodeType&&!/\S+/.test(d.nodeValue)||(h&&3!==d.nodeType&&"inline"===t(d).display&&(d.style.display="inline-block",d.style.position="relative"),d._isSplit=!0,c(d,s,r,l));return s.absolute=h,void(e._isSplit=!0)}f(e,s,r,l)}var u,g,x,y,b=/(?:\r|\n|\t\t)/g,_=/(?:\s\s+)/g,C=Array.isArray,S=[].slice,w=((y=N.prototype).split=function(e){this.isSplit&&this.revert(),this.vars=e=e||this.vars,this._originals.length=this.chars.length=this.words.length=this.lines.length=0;for(var t,i,n,s=this.elements.length,l=e.tag?e.tag:e.span?"span":"div",o=r(e.wordsClass,l),d=r(e.charsClass,l);-1<--s;)n=this.elements[s],this._originals[s]=n.innerHTML,t=n.clientHeight,i=n.clientWidth,c(n,e,o,d),h(n,e,this.chars,this.words,this.lines,i,t);return this.chars.reverse(),this.words.reverse(),this.lines.reverse(),this.isSplit=!0,this},y.revert=function(){var e=this._originals;if(!e)throw"revert() call wasn't scoped properly.";return this.elements.forEach(function(t,i){return t.innerHTML=e[i]}),this.chars=[],this.words=[],this.lines=[],this.isSplit=!1,this},N.create=function(e,t){return new N(e,t)},N);function N(e,t){x||(u=document,g=window,x=1),this.elements=i(e),this.chars=[],this.words=[],this.lines=[],this._originals=[],this.vars=t||{},this.split(t)}w.version="3.2.3",e.Text=w,e.default=w,"undefined"==typeof window||window!==e?Object.defineProperty(e,"__esModule",{value:!0}):delete e.default});
